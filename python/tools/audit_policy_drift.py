...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--joint-hidden-dim", type=int, default=training_defaults.joint_hidden_dim)
    parser.add_argument("--search-simulations", type=int, default=training_defaults.search_simulations)
    parser.add_argument("--eval-every", type=int, default=training_defaults.eval_every)
    parser.add_argument("--c-puct", type=float, default=training_defaults.c_puct)
    parser.add_argument("--root-dirichlet-alpha", type=float, default=training_defaults.root_dirichlet_alpha)
    parser.add_argument("--root-dirichlet-epsilon", type=float, default=training_defaults.root_dirichlet_epsilon)
    parser.add_argument("--self-play-temperature", type=float, default=training_defaults.self_play_temperature)
    parser.add_argument("--value-loss-coef", type=float, default=training_defaults.value_loss_coef)
    parser.add_argument("--entropy-coef", type=float, default=training_defaults.entropy_coef)
    parser.add_argument("--grad-clip-norm", type=float, default=training_defaults.grad_clip_norm)
