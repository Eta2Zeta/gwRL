...
def build():
    ...
    land_nodes = [
        ("land_neu_netherlands", "Netherlands", "normal", 2, "Netherlands", "Netherlands", False, False),
        ("land_neu_belgium", "Belgium", "normal", 2, "Belgium", "Belgium", False, False),
        ("land_ger_western_germany", "Western Germany", "normal", 4, "Germany", "Germany", False, False),
        ("land_ger_eastern_germany", "Eastern Germany", "normal", 2, "Germany", "Germany", False, False),
        ("land_ger_bavaria", "Bavaria", "normal", 3, "Germany", "Germany", False, False),
        ("land_ger_berlin", "Berlin", "city", 8, "Germany", "Germany", True, True),
        ("land_fra_normandy", "Normandy", "normal", 1, "France", "France", False, False),
        ("land_fra_picardy", "Picardy", "normal", 2, "France", "France", False, False),
        ("land_fra_paris", "Paris", "city", 3, "France", "France", True, True),
        ("land_fra_aquitaine", "Aquitaine", "normal", 1, "France", "France", False, False),
        ("land_fra_southern_france", "Southern France", "normal", 2, "France", "France", False, False),
        ("land_fra_alsace_lorraine", "Alsace-Lorraine", "normal", 2, "France", "France", False, False),
        ("land_gbr_scotland", "Scotland", "mountain_border", 2, "United Kingdom", "United Kingdom", False, False),
        ("land_gbr_northern_england", "Northern England", "normal", 3, "United Kingdom", "United Kingdom", False, False),
        ("land_gbr_southern_england", "Southern England", "normal", 2, "United Kingdom", "United Kingdom", False, False),
        ("land_gbr_london", "London", "city", 3, "United Kingdom", "United Kingdom", True, True),
        ("land_ireland", "Ireland", "normal", 2, "Ireland", "Ireland", False, False),
        ("land_ita_northern_italy", "Northern Italy", "normal", 4, "Italy", "Italy", False, False),
        ("land_ita_lazio", "Lazio", "normal", 1, "Italy", "Italy", False, False),
        ("land_ita_rome", "Rome", "city", 2, "Italy", "Italy", True, True),
        ("land_ita_southern_italy", "Southern Italy", "normal", 2, "Italy", "Italy", False, False),
        ("land_denmark", "Denmark", "normal", 1, "Denmark", "Denmark", True, True),
        ("land_nor_southern_norway", "Southern Norway", "mountain", 1, "Norway", "Norway", False, False),
        ("land_nor_trondelag", "Trondelag", "mountain", 1, "Norway", "Norway", False, False),
        ("land_swe_norrland", "Norrland", "tundra", 2, "Sweden", "Sweden", False, False),
        ("land_swe_gotland", "Gotland", "normal", 1, "Sweden", "Sweden", False, False),
        ("land_fin_lapland", "Lapland", "tundra", 1, "Finland", "Finland", False, False),
        ("land_fin_southern_finland", "Southern Finland", "forest", 1, "Finland", "Finland", True, True),
        ("land_fin_viipuri_province", "Viipuri Province", "forest", 1, "Finland", "Finland", False, False),
        ("land_estonia", "Estonia", "normal", 1, "Estonia", "Estonia", False, False),
        ("land_latvia", "Latvia", "normal", 1, "Latvia", "Latvia", False, False),
        ("land_lithuania", "Lithuania", "normal", 1, "Lithuania", "Lithuania", False, False),
        ("land_ger_konigsberg", "Konigsberg", "normal", 1, "Germany", "Germany", False, False),
        ("land_pol_west_poland", "West Poland", "normal", 1, "Poland", "Poland", False, False),
        ("land_pol_podlachia", "Podlachia", "normal", 1, "Poland", "Poland", False, False),
        ("land_pol_lubelskie", "Lubelskie", "normal", 1, "Poland", "Poland", False, False),
        ("land_pol_warsaw", "Warsaw", "city", 1, "Poland", "Poland", True, True),
        ("land_pol_dolnoslaskie", "Dolnoslaskie", "normal", 1, "Poland", "Poland", False, False),
        ("land_pol_east_poland", "East Poland", "normal", 1, "Poland", "Poland", False, False),
        ("land_cze_bohemia", "Bohemia", "normal", 1, "Czechoslovakia", "Czechoslovakia", False, False),
        ("land_cze_slovakia", "Slovakia", "mountain", 1, "Czechoslovakia", "Czechoslovakia", False, False),
        ("land_aut_austria", "Austria", "mountain", 2, "Austria", "Austria", True, False),
        ("land_hun_hungary", "Hungary", "normal", 2, "Hungary", "Hungary", True, False),
        ("land_rom_central_romania", "Central Romania", "mountain", 2, "Romania", "Romania", False, False),
        ("land_rom_bessarabia", "Bessarabia", "normal", 1, "Romania", "Romania", False, False),
        ("land_bulgaria", "Bulgaria", "normal", 1, "Bulgaria", "Bulgaria", True, False),
        ("land_yug_western_yugoslavia", "Western Yugoslavia", "mountain", 2, "Yugoslavia", "Yugoslavia", False, False),
        ("land_yug_eastern_yugoslavia", "Eastern Yugoslavia", "mountain", 1, "Yugoslavia", "Yugoslavia", True, False),
        ("land_albania", "Albania", "mountain", 1, "Albania", "Albania", False, False),
        ("land_gre_macedonia", "Macedonia", "mountain", 1, "Greece", "Greece", False, False),
        ("land_gre_thessaly", "Thessaly", "mountain", 1, "Greece", "Greece", False, False),
        ("land_ita_sardinia", "Sardinia", "mountain", 1, "Italy", "Italy", False, False),
        ("land_fra_corsica", "Corsica", "mountain", 1, "France", "France", False, False),
        ("land_switzerland", "Switzerland", "mountain", 1, "Switzerland", "Switzerland", False, False),
        ("land_esp_basque_country", "Basque Country", "mountain", 1, "Spain", "Spain", False, False),
        ("land_esp_catalonia", "Catalonia", "mountain", 1, "Spain", "Spain", False, False),

        ("land_tur_istanbul", "Istanbul", "city", 2, "Turkey", "Turkey", True, True),
        ("land_tur_karadeniz", "Karadeniz", "mountain", 0, "Turkey", "Turkey", False, False),
        ("land_tur_ankara", "Ankara", "mountain", 1, "Turkey", "Turkey", True, False),
        ("land_tur_akdeniz", "Akdeniz", "mountain", 0, "Turkey", "Turkey", False, False),
        ("land_tur_eastern_anatolia", "Eastern Anatolia", "mountain", 1, "Turkey", "Turkey", False, False),
        ("land_azerbaijan", "Azerbaijan", "mountain", 1, "Azerbaijan", "Azerbaijan", False, False),

        ("land_usr_kola", "Kola", "tundra", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_karelia", "Karelia", "forest", 2, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_northern_russia", "Northern Russia", "tundra", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_yaroslavl", "Yaroslavl", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_western_russia", "Western Russia", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_leningrad", "Leningrad", "city", 2, "Soviet Union", "Soviet Union", False, True),
        ("land_usr_moscow", "Moscow", "city", 4, "Soviet Union", "Soviet Union", True, True),
        ("land_usr_stalingrad", "Stalingrad", "city", 1, "Soviet Union", "Soviet Union", False, True),
        ("land_usr_gorky", "Gorky", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_smolensk", "Smolensk", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_northern_belorussia", "Northern Belorussia", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_southern_belorussia", "Southern Belorussia", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_western_ukraine", "Western Ukraine", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_kiev", "Kiev", "city", 0, "Soviet Union", "Soviet Union", False, True),
        ("land_usr_eastern_ukraine", "Eastern Ukraine", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_southern_ukraine", "Southern Ukraine", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_taurida", "Taurida", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_crimea", "Crimea", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_donets_kuban", "Donets-Kuban", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_kalmytskaya", "Kalmytskaya", "normal", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_north_caucasia", "North-Caucasia", "mountain", 3, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_transcaucasia", "Transcaucasia", "mountain", 5, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_tula_lipetsk", "Tula-Lipetsk", "normal", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_orel_kursk", "Orel-Kursk", "normal", 2, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_saratov", "Saratov", "normal", 3, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_kaluga_oblast", "Kaluga Oblast", "normal", 0, "Soviet Union", "Soviet Union", False, False),

        ("land_syria", "Syria", "normal", 1, "Syria", "Syria", False, False),
        ("land_northern_iraq", "Northern Iraq", "desert", 1, "Iraq", "Iraq", False, False),
        ("land_southern_iraq", "Southern Iraq", "desert", 1, "Iraq", "Iraq", True, False),
        ("land_transjordan", "Transjordan", "desert", 0, "Transjordan", "Transjordan", False, False),
        ("land_kuwait", "Kuwait", "desert", 0, "Kuwait", "Kuwait", False, False),
        ("land_iran_northern_iran", "Northern Iran", "mountain", 1, "Iran", "Iran", False, False),
        ("land_iran_southern_iran", "Southern Iran", "mountain", 2, "Iran", "Iran", False, False),
        ("land_afghanistan", "Afghanistan", "mountain", 0, "Afghanistan", "Afghanistan", False, False),
        ("land_kashmir", "Kashmir", "mountain", 0, "Kashmir", "Kashmir", False, False),
        ("land_tibet", "Tibet", "mountain", 0, "Tibet", "Tibet", False, False),
        ("land_nepal", "Nepal", "mountain", 0, "Nepal", "Nepal", False, False),
        ("land_india_punjab", "Punjab", "normal", 0, "British India", "British India", False, False),
        ("land_india_delhi", "Delhi", "city", 1, "British India", "British India", False, False),
        ("land_india_maharashtra", "Maharashtra", "normal", 1, "British India", "British India", False, False),
        ("land_india_benares", "Benares", "normal", 1, "British India", "British India", False, False),
        ("land_india_calcutta", "Calcutta", "city", 3, "British India", "British India", False, False),
        ("land_india_southern_india", "Southern India", "normal", 1, "British India", "British India", False, False),
        ("land_india_ceylon", "Ceylon", "normal", 0, "British India", "British India", False, False),
        ("land_burma", "Burma", "jungle", 1, "British India", "British India", False, False),
        ("land_saudi_arabia", "Saudi Arabia", "desert", 0, "Saudi Arabia", "Saudi Arabia", False, False),
        ("land_qatar", "Qatar", "desert", 0, "Qatar", "Qatar", False, False),
        ("land_oman", "Oman", "desert", 0, "Oman", "Oman", False, False),
        ("land_aden", "Aden", "desert", 0, "United Kingdom", None, False, False),

        ("land_can_district_of_keewatin", "District of Keewatin", "tundra", 0, "Canada", "Canada", False, False),
        ("land_can_baffin_island", "Baffin Island", "tundra", 0, "Canada", "Canada", False, False),
        ("land_can_manitoba", "Manitoba", "normal", 1, "Canada", "Canada", False, False),
        ("land_can_ontario", "Ontario", "normal", 2, "Canada", "Canada", False, False),
        ("land_can_quebec", "Quebec", "normal", 1, "Canada", "Canada", False, False),
        ("land_can_labrador", "Labrador", "normal", 1, "Canada", "Canada", False, False),
        ("land_can_newfoundland", "Newfoundland", "normal", 1, "Canada", "Canada", False, False),
        ("land_can_nova_scotia", "Nova Scotia", "normal", 1, "Canada", "Canada", False, False),
        ("land_can_st_pierre_island", "St. Pierre Island", "normal", 0, "France", None, False, False),
        ("land_can_british_columbia", "British Columbia", "mountain", 1, "Canada", "Canada", False, False),
        ("land_can_alberta_saskatchewan", "Alberta-Saskatchewan", "normal", 0, "Canada", "Canada", False, False),

        ("land_usa_pacific_northwest", "Pacific Northwest", "forest", 1, "United States", "United States", False, False),
        ("land_usa_western_united_states", "Western United States", "mountain", 2, "United States", "United States", False, False),
        ("land_usa_southwest_united_states", "Southwest United States", "desert", 2, "United States", "United States", False, False),
        ("land_usa_great_plains", "Great Plains", "normal", 3, "United States", "United States", False, False),
        ("land_usa_upper_midwest", "Upper Midwest", "normal", 1, "United States", "United States", False, False),
        ("land_usa_midwest", "Midwest", "normal", 2, "United States", "United States", False, False),
        ("land_usa_great_lakes", "Great Lakes", "normal", 2, "United States", "United States", False, False),
        ("land_usa_heartlands", "Heartlands", "normal", 3, "United States", "United States", False, False),
        ("land_usa_the_northeast", "The Northeast", "normal", 5, "United States", "United States", False, False),
        ("land_usa_new_york", "New York", "city", 4, "United States", "United States", False, False),
        ("land_usa_washington_dc", "Washington, D.C.", "city", 5, "United States", "United States", True, False),
        ("land_usa_appalachia", "Appalachia", "mountain", 1, "United States", "United States", False, False),
        ("land_usa_the_carolinas", "The Carolinas", "normal", 2, "United States", "United States", False, False),
        ("land_usa_southeastern_united_states", "Southeastern United States", "normal", 2, "United States", "United States", False, False),
        ("land_usa_new_orleans", "New Orleans", "normal", 2, "United States", "United States", False, False),
        ("land_usa_texas", "Texas", "normal", 3, "United States", "United States", False, False),
        ("land_usa_chicago", "Chicago", "normal", 2, "United States", "United States", False, False),
        ("land_usa_san_francisco", "San Francisco", "city", 4, "United States", "United States", False, False),

        ("land_mex_western_mexico", "Western Mexico", "mountain", 0, "Mexico", "Mexico", False, False),
        ("land_mex_eastern_mexico", "Eastern Mexico", "normal", 1, "Mexico", "Mexico", False, False),
        ("land_central_america", "Central America", "jungle", 0, "Central America", "Central America", False, False),
        ("land_panama", "Panama", "jungle", 2, "Panama", "Panama", False, False),
        ("land_cuba", "Cuba", "normal", 1, "Cuba", "Cuba", False, False),
        ("land_hispaniola", "Hispaniola", "normal", 1, "Hispaniola", "Hispaniola", False, False),
        ("land_puerto_rico", "Puerto Rico", "normal", 0, "United States", None, False, False),
        ("land_bermuda", "Bermuda", "normal", 0, "United Kingdom", None, False, False),

        ("land_colombia", "Colombia", "mountain", 1, "Colombia", "Colombia", False, False),
        ("land_venezuela", "Venezuela", "normal", 1, "Venezuela", "Venezuela", False, False),
        ("land_ecuador", "Ecuador", "mountain", 1, "Ecuador", "Ecuador", False, False),
        ("land_peru", "Peru", "mountain", 1, "Peru", "Peru", False, False),
        ("land_bolivia", "Bolivia", "mountain", 1, "Bolivia", "Bolivia", False, False),
        ("land_brazil_amazon_jungle", "Amazon Jungle", "jungle", 1, "Brazil", "Brazil", False, False),
        ("land_brazil_caatinga", "Caatinga", "normal", 1, "Brazil", "Brazil", False, False),
        ("land_brazil_rio_de_janeiro", "Rio de Janeiro", "city", 1, "Brazil", "Brazil", False, False),
        ("land_brazil_pampas", "Pampas", "normal", 1, "Brazil", "Brazil", False, False),
        ("land_paraguay", "Paraguay", "normal", 1, "Paraguay", "Paraguay", False, False),
        ("land_uruguay", "Uruguay", "normal", 1, "Uruguay", "Uruguay", False, False),
        ("land_buenos_aires", "Buenos Aires", "city", 1, "Argentina", "Argentina", True, False),
        ("land_patagonia", "Patagonia", "normal", 1, "Argentina", "Argentina", False, False),
        ("land_chile", "Chile", "mountain", 1, "Chile", "Chile", False, False),
        ("land_rio_grande", "Rio Grande", "normal", 1, "Argentina", "Argentina", False, False),
        ("land_guyana", "Guyana", "jungle", 0, "Guyana", "Guyana", False, False),
        ("land_suriname", "Suriname", "jungle", 0, "Suriname", "Suriname", False, False),
        ("land_french_guiana", "French Guiana", "jungle", 0, "France", None, False, False),

        ("land_french_morocco", "French Morocco", "mountain", 1, "France", None, False, False),
        ("land_spanish_morocco", "Spanish Morocco", "mountain", 0, "Spain", None, False, False),
        ("land_northern_algeria", "Northern Algeria", "mountain", 0, "France", None, False, False),
        ("land_western_algeria", "Western Algeria", "desert", 0, "France", None, False, False),
        ("land_southern_algeria", "Southern Algeria", "desert", 0, "France", None, False, False),
        ("land_tunisia", "Tunisia", "desert", 1, "France", None, False, False),
        ("land_tripoli", "Tripoli", "desert", 1, "Italy", None, False, False),
        ("land_tripolitania", "Tripolitania", "desert", 0, "Italy", None, False, False),
        ("land_cyrenaica", "Cyrenaica", "desert", 1, "Italy", None, False, False),
        ("land_tobruk", "Tobruk", "desert", 0, "Italy", None, False, False),
        ("land_western_egypt", "Western Egypt", "desert", 1, "Egypt", "Egypt", False, False),
        ("land_upper_egypt", "Upper Egypt", "desert", 0, "Egypt", "Egypt", False, False),
        ("land_lower_egypt", "Lower Egypt", "desert", 1, "Egypt", "Egypt", False, False),
        ("land_nubia", "Nubia", "desert", 1, "Egypt", "Egypt", False, False),
        ("land_eritrea", "Eritrea", "mountain", 0, "Italy", None, False, False),
        ("land_abyssinia", "Abyssinia", "mountain", 0, "Ethiopia", "Ethiopia", False, False),
        ("land_french_somaliland", "French Somaliland", "normal", 0, "France", None, False, False),
        ("land_british_somaliland", "British Somaliland", "desert", 0, "United Kingdom", None, False, False),
        ("land_italian_somaliland", "Italian Somaliland", "desert", 1, "Italy", None, False, False),
        ("land_sudan", "Sudan", "desert", 0, "United Kingdom", None, False, False),
        ("land_french_sudan", "French Sudan", "desert", 0, "France", None, False, False),
        ("land_niger", "Niger", "desert", 0, "France", None, False, False),
        ("land_chad", "Chad", "desert", 0, "France", None, False, False),
        ("land_dahomey", "Dahomey", "normal", 0, "France", None, False, False),
        ("land_nigeria", "Nigeria", "normal", 0, "United Kingdom", None, False, False),
        ("land_cameroon", "Cameroon", "jungle", 1, "France", None, False, False),
        ("land_oubangui_chari", "Oubangui-Chari", "jungle", 0, "France", None, False, False),
        ("land_belgian_congo", "Belgian Congo", "jungle", 1, "Belgium", None, False, False),
        ("land_angola", "Angola", "normal", 0, "Portugal", None, False, False),
        ("land_tanganyika", "Tanganyika", "normal", 0, "United Kingdom", None, False, False),
        ("land_rhodesia", "Rhodesia", "normal", 1, "United Kingdom", None, False, False),
        ("land_portuguese_east_africa", "Portuguese East Africa", "normal", 1, "Portugal", None, False, False),
        ("land_southwest_africa", "Southwest Africa", "desert", 0, "South Africa", None, False, False),
        ("land_bechuanaland", "Bechuanaland", "normal", 0, "South Africa", None, False, False),
        ("land_cape_town", "Cape Town", "normal", 1, "South Africa", "South Africa", False, False),
        ("land_south_africa", "South Africa", "normal", 1, "South Africa", "South Africa", False, False),
        ("land_madagascar", "Madagascar", "jungle", 1, "France", None, False, False),
        ("land_mauritius", "Mauritius", "normal", 0, "United Kingdom", None, False, False),
        ("land_seychelles", "Seychelles", "normal", 0, "United Kingdom", None, False, False),

        ("land_usr_stalino", "Stalino", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_vanavara", "Vanavara", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_irkutsk", "Irkutsk", "tundra", 1, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_angara", "Angara", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_yakutsk", "Yakutsk", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_southern_yakutia", "Southern Yakutia", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_magadan", "Magadan", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_kamchatka", "Kamchatka", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_amur", "Amur", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_chita", "Chita", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_buryatia", "Buryatia", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_primorsky_krai", "Primorsky Krai", "tundra", 2, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_north_sakhalin", "North Sakhalin", "tundra", 0, "Soviet Union", "Soviet Union", False, False),
        ("land_usr_south_sakhalin", "South Sakhalin", "tundra", 0, "Soviet Union", "Soviet Union", False, False),

        ("land_mongolia_tannu_tuva", "Tannu Tuva", "mountain", 0, "Mongolia", "Mongolia", False, False),
        ("land_mongolia_kobdo", "Kobdo", "mountain", 0, "Mongolia", "Mongolia", False, False),
        ("land_mongolia_ulyassutai", "Ulyassutai", "mountain", 0, "Mongolia", "Mongolia", False, False),
        ("land_mongolia_central_mongolia", "Central Mongolia", "mountain", 0, "Mongolia", "Mongolia", False, False),
        ("land_mongolia_kherlen", "Kherlen", "mountain", 1, "Mongolia", "Mongolia", False, False),

        ("land_manchuria_northern", "Northern Manchuria", "normal", 1, "Japan", "Manchukuo", False, False),
        ("land_manchuria_western", "Western Manchuria", "normal", 1, "Japan", "Manchukuo", False, False),
        ("land_manchuria_eastern", "Eastern Manchuria", "normal", 1, "Japan", "Manchukuo", False, False),
        ("land_manchuria_rehe", "Rehe", "normal", 1, "Japan", "Manchukuo", False, False),
        ("land_china_suiyuan", "Suiyuan", "normal", 1, "China", "China", False, False),
        ("land_china_hopeh", "Hopeh", "normal", 1, "China", "China", False, False),
        ("land_china_beiping", "Beiping", "city", 2, "China", "China", False, False),
        ("land_china_shantung", "Shantung", "normal", 2, "China", "China", False, False),
        ("land_china_nanking", "Nanking", "city", 2, "China", "China", False, False),
        ("land_china_hunan", "Hunan", "normal", 2, "China", "China", False, False),
        ("land_china_shensi", "Shensi", "normal", 2, "China", "China", False, False),
        ("land_china_szechwan", "Szechwan", "mountain", 2, "China", "China", False, False),
        ("land_china_kweichow", "Kweichow", "mountain", 0, "China", "China", False, False),
        ("land_china_yunnan", "Yunnan", "mountain", 1, "China", "China", False, False),
        ("land_china_tsinghai", "Tsinghai", "mountain", 0, "China", "China", False, False),
        ("land_china_sinkiang", "Sinkiang", "mountain", 0, "China", "China", False, False),
        ("land_jap_tokyo", "Tokyo", "city", 3, "Japan", "Japan", True, True),
        ("land_jap_honshu", "Honshu", "normal", 2, "Japan", "Japan", False, False),
        ("land_jap_hokkaido", "Hokkaido", "forest", 1, "Japan", "Japan", False, False),
        ("land_jap_kyushu", "Kyushu", "mountain", 1, "Japan", "Japan", False, False),
        ("land_korea", "Korea", "mountain", 2, "Japan", None, False, False),
        ("land_formosa", "Formosa", "normal", 2, "Japan", None, False, False),
        ("land_hainan", "Hainan", "normal", 1, "Japan", None, False, False),
        ("land_hong_kong", "Hong Kong", "city", 2, "United Kingdom", None, False, False),
        ("land_kwangtung", "Kwangtung", "normal", 2, "China", "China", False, False),
        ("land_kwangsi", "Kwangsi", "jungle", 0, "China", "China", False, False),
        ("land_annam_tonkin", "Annam-Tonkin", "jungle", 1, "France", None, False, False),
        ("land_cochinchina", "Cochinchina", "jungle", 1, "France", None, False, False),
        ("land_siam", "Siam", "jungle", 1, "Siam", "Siam", False, False),
        ("land_luzon_and_the_visayas", "Luzon and the Visayas", "jungle", 1, "Philippines", "Philippines", False, False),
        ("land_mindanao", "Mindanao", "jungle", 1, "Philippines", "Philippines", False, False),
        ("land_guam", "Guam", "normal", 0, "United States", None, False, False),
        ("land_palau", "Palau", "normal", 0, "Japan", None, False, False),

        ("land_sumatra", "Sumatra", "jungle", 2, "Netherlands", None, False, False),
        ("land_java", "Java", "jungle", 2, "Netherlands", None, False, False),
        ("land_borneo", "Borneo", "jungle", 2, "Netherlands", None, False, False),
        ("land_celebes", "Celebes", "jungle", 1, "Netherlands", None, False, False),
        ("land_timor", "Timor", "normal", 1, "Portugal", None, False, False),
        ("land_dutch_new_guinea", "Dutch New Guinea", "jungle", 1, "Netherlands", None, False, False),
        ("land_new_guinea", "New Guinea", "jungle", 1, "Australia", None, False, False),
        ("land_new_britain", "New Britain", "jungle", 1, "Australia", None, False, False),

        ("land_aus_western_australia", "Western Australia", "desert", 0, "Australia", "Australia", False, False),
        ("land_aus_northern_territory", "Northern Territory", "desert", 0, "Australia", "Australia", False, False),
        ("land_aus_south_australia", "South Australia", "desert", 0, "Australia", "Australia", False, False),
        ("land_aus_queensland", "Queensland", "normal", 1, "Australia", "Australia", False, False),
        ("land_aus_new_south_wales", "New South Wales", "normal", 2, "Australia", "Australia", False, False),
        ("land_aus_tasmania", "Tasmania", "normal", 0, "Australia", "Australia", False, False),
        ("land_nz_north_island", "North Island", "normal", 1, "New Zealand", "New Zealand", False, False),
        ("land_nz_south_island", "South Island", "normal", 0, "New Zealand", "New Zealand", False, False),
        ("land_new_caledonia", "New Caledonia", "normal", 0, "France", None, False, False),
        ("land_fiji", "Fiji", "normal", 0, "United Kingdom", None, False, False),
        ("land_new_hebrides", "New Hebrides", "normal", 0, "United Kingdom", None, False, False),
    ]

    for node_id, name, terrain, ipp, owner, home, cap, vc in land_nodes:
        add_node(
            nodes,
            node_id,
            name=name,
